            ...
            <div className="flex flex-col md:flex-row md:space-x-14 w-full mt-10 md:mt-14">
              ...
              <div className="flex flex-col items-center w-full px-4 mt-16 md:mt-0">
                ...
                {wallet ? (
                  ...
                  <button
                    className="font-coiny mt-12 w-full bg-gradient-to-br from-brand-blue to-brand-blue shadow-lg px-6 py-3 rounded-md text-2xl text-yellow hover:shadow-yellow-400/50 mx-4 tracking-wide uppercase"
                    onClick={() => connect()}
                  >
                    Connect Wallet
                  </button>
